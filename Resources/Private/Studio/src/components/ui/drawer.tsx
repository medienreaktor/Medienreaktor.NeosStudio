...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        'fixed inset-0 z-200 bg-white/80 dark:bg-neutral-950/80 transition-opacity duration-300 data-starting-style:opacity-0 data-ending-style:opacity-0',
        className,
      )}
      {...props}
    />
      ...
      <DrawerPrimitive.Viewport className="pointer-events-none fixed inset-0 z-200 flex items-stretch justify-end">
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            'pointer-events-auto mt-2 mr-4 mb-2 flex w-96 max-w-[calc(100vw-3rem)] flex-col overflow-y-auto overscroll-contain rounded-lg border bg-neutral-50 dark:bg-neutral-900 text-neutral-950 dark:text-white shadow-lg outline-none',
